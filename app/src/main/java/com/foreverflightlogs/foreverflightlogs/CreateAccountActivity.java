...
/**
 * Create Account Activity User will be able to create an account by providing their phone number,
 * name, and password. After successful creation, they will be taken to login screen where they will
 * login, to create an authorization code to begin using the site
 */
    ...
    if (o != null && o instanceof CreateAccountPresenter) {
      if (arg == "200") {
        this.runOnUiThread(new Runnable() {
          public void run() {
            Toast.makeText(CreateAccountActivity.this, "Account Successfully Created, Please Login",
        ...
        this.runOnUiThread(new Runnable() {
          public void run() {
            Toast.makeText(CreateAccountActivity.this,
                "Invalid Registration Details - Create Account Online", Toast.LENGTH_SHORT).show();
          }
        });
      }
    }
